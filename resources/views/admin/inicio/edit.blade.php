        ...
        <div class="page-content">
            <div class="page-bar">
                <div class="page-title-breadcrumb">
                    <div class=" pull-left">
                        <div class="page-title"> Cadastrar Inicio </div>
                    </div>
                ...
                <div class="col-md-12 col-sm-12">
                    <div class="card card-box">
                        ...
                        <div class="card-body" id="bar-parent">
                            ...
                            <form action="{{ route('inicio.update', $Inicio->id) }}" method="post"
                                ...
                                <div class="form-body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <label class="control-label col-md-3">Nome do Inicio
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-5">
                                            <textarea name="descricao" placeholder="Descrição" class="form-control-textarea " rows="5"> {{ $Inicio->descricao }}  </textarea>
