							...
							<div class="chat-sidebar-list">
								<div class="chat-sidebar-chat-users slimscroll-style" data-rail-color="#ddd"
									...
									<ul class="media-list list-items">
										<li class="media"><img class="media-object" src="{{asset('admin')}}/assets/img/user/user3.jpg"
										...
										<li class="media"><img class="media-object" src="{{asset('admin')}}/assets/img/user/user5.jpg"
												width="35" height="35" alt="...">
											<i class="away dot"></i>
											<div class="media-body">
										...
										<li class="media"><img class="media-object" src="{{asset('admin')}}/assets/img/user/user2.jpg"
												width="35" height="35" alt="...">
											<i class="busy dot"></i>
											<div class="media-body">
										...
										<li class="media"><img class="media-object" src="{{asset('admin')}}/assets/img/user/user7.jpg"
												width="35" height="35" alt="...">
											<i class="online dot"></i>
											<div class="media-body">
									...
									<ul class="media-list list-items">
										...
										<li class="media"><img class="media-object" src="{{asset('admin')}}/assets/img/user/user8.jpg"
												width="35" height="35" alt="...">
											<i class="offline dot"></i>
											<div class="media-body">
										...
										<li class="media"><img class="media-object" src="{{asset('admin')}}/assets/img/user/user10.jpg"
												width="35" height="35" alt="...">
											<i class="offline dot"></i>
											<div class="media-body">
	...
	<script src="{{asset('admin')}}/assets/js/pages/chart/apex/home-data.js"></script>
	<!-- summernote -->
	...
	<!-- end js include path -->
        ...
        <script src="{{asset('admin')}}/assets/plugins/datatables/plugins/bootstrap/dataTables.bootstrap5.min.js"></script>
...
<!-- Mirrored from www.einfosoft.com/templates/admin/smart/source/light/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 12 Apr 2022 16:25:20 GMT -->
</html>
