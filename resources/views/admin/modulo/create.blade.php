				...
				<div class="page-content">
					<div class="page-bar">
						<div class="page-title-breadcrumb">
							<div class=" pull-left">
								<div class="page-title"> Cadastrar modulo  </div>
							</div>
						...
						<div class="col-md-12 col-sm-12">
							<div class="card card-box">
								...
								<div class="card-body" id="bar-parent">
                                    ...
                                    <form action="{{ route('modulo.store') }}" method="post" enctype="multipart/form-data"  id="form_sample_1" class="form-horizontal">
										...
										<div class="form-body">
											...
											<div class="form-group row">
												<label class="control-label col-md-3"> Selecione o produto <span class="required" aria-required="true"> * </span>
													
												</label>
												<div class="col-md-5">

													<select  name="produto" class="form-select input-height @error('produto') is-invalid @enderror">
														<option value="" selected> Selecione o produto </option>
														@foreach ($produtos = App\Models\Produto::orderBy('id','desc')->get() as $produto)
											...
											<div class="form-group row">
												...
												<label class="control-label col-md-3">Nome do módulo
													<span class="required"> * </span>
												</label>

												<div class="col-md-5">
													<input type="text" name="nome_modulo" data-required="1"
														placeholder="Insira o nome do modulo"
														class="form-control input-height  @error('nome_modulo') is-invalid @enderror" />
