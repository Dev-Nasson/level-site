        ...
        <div class="page-content">
            <div class="page-bar">
                <div class="page-title-breadcrumb">
                    <div class=" pull-left">
                        <div class="page-title"> Listar produtos</div>
                    </div>
                        ...
                        <div class="card-body ">
                            ...
                            <table class="table table-striped table-bordered table-hover table-checkable order-column"
                                ...
                                <tbody>
                                    ...
                                    @php
                                        $modulo = App\Models\Moduloproduto::where('produto_id',$artigo->id);
                                    @endphp
                                        ...
                                        <td class="valigntop">
                                            <div class="btn-group">
                                                ...
                                                <ul class="dropdown-menu pull-left" role="menu">
                                                    ...
                                                    <li>
                                                        <a  href="{{url('auth/produto')}}/{{$artigo->id}}/edit ">
                                                    ...
                                                    <li>
                                                        <a href="{{ url('auth/produto/show')}}?idpro={{ $artigo->id }}">
                                                    ...
                                                    <li>
                                                        <a href="{{url('auth/modulo/create')}}">
                                                            <i class="icon-flag"></i> Módulo

                                                            <span class="badge badge-success"> {{ $modulo->count(); }} </span>
                                                        ...
                                                        <form  action="{{route('produto.accao',$artigo->id)}}" method="post" enctype="multipart/form-data">
