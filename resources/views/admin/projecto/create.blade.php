				...
				<div class="page-content">
					<div class="page-bar">
						<div class="page-title-breadcrumb">
							<div class=" pull-left">
								<div class="page-title"> Cadastrar Projecto  </div>
							</div>
						...
						<div class="col-md-12 col-sm-12">
							<div class="card card-box">
								...
								<div class="card-body" id="bar-parent">
                                    ...
                                    <form action="{{ route('projecto.store') }}" method="post" enctype="multipart/form-data"  id="form_sample_1" class="form-horizontal">
										...
										<div class="form-body">
											...
											<div class="form-group row">
												...
												<label class="control-label col-md-3">Titulo do projecto
													<span class="required"> * </span>
												</label>

												<div class="col-md-5">
													<input type="text" name="titulo" data-required="1"
														placeholder="Insira o titulo do projecto"
														class="form-control input-height  @error('titulo') is-invalid @enderror" />
