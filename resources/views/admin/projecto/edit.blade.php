				...
				<div class="page-content">
					<div class="page-bar">
						<div class="page-title-breadcrumb">
							<div class=" pull-left">
								<div class="page-title"> Editar projecto  </div>
							</div>
											...
											<div class="form-group row">
												...
												<div class="col-md-5">
													<input type="text" name="titulo" data-required="1"
														...
														class="form-control input-height " value="{{ $projecto->titulo }} " />
											...
											<div class="form-group row">
												...
												<div class="col-md-5">
													<textarea name="descricao"  placeholder="Descrição"
														class="form-control-textarea "  rows="5"> {{ $projecto->descricao }}  </textarea>
