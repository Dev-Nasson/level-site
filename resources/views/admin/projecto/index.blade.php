        ...
        <div class="page-content">
            <div class="page-bar">
                <div class="page-title-breadcrumb">
                    <div class=" pull-left">
                        <div class="page-title"> Listar projectos</div>
                    </div>
                            ...
                            <table class="table table-striped table-bordered table-hover table-checkable order-column"
                                ...
                                <tbody>
                                    ...
                                    <tr class="odd gradeX">
                                        ...
                                        <td>   <img src="{{asset('levelschool')}}/" class="rounded mx-auto d-block" alt="..."> </td>
                                        ...
                                        <td class="valigntop">
                                            <div class="btn-group">
                                                ...
                                                <ul class="dropdown-menu pull-left" role="menu">
                                                    <li>
                                                        <a href="{{url('auth/projecto')}}/{{$artigo->id}}/edit ">
                                                    ...
                                                    <li>
                                                        ...
                                                        <a href="javascript:;">
                                                            ...
                                                            <form  action="{{route('projecto.accao',$artigo->id)}}" method="post" enctype="multipart/form-data">
