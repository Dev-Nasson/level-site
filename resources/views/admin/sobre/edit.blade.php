        ...
        <div class="page-content">
            <div class="page-bar">
                <div class="page-title-breadcrumb">
                    <div class=" pull-left">
                        <div class="page-title"> Cadastrar Sobre </div>
                    </div>
                    <ol class="breadcrumb page-breadcrumb pull-right">
                        <li><i class="fa fa-home"></i>&nbsp;<a class="parent-item" href="index.html">Home</a>&nbsp;<i
                                class="fa fa-angle-right"></i>
                        </li>
                        <li><a class="parent-item" href="#">sobre</a>&nbsp;<i class="fa fa-angle-right"></i>
                        </li>
                        <li class="active">Add sobre</li>
                    </ol>
                </div>
            </div>
            <div class="row">
                <div class="col-md-12 col-sm-12">
                    <div class="card card-box">
                        ...
                        <div class="card-body" id="bar-parent">
                            ...
                            <form action="{{ route('sobre.update', $sobre->id) }}" method="post"
                                ...
                                <div class="form-body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <label class="control-label col-md-3">Nome do titulo
                                            <span class="required"> * </span>
                                        </label>

                                        <div class="col-md-5">
                                            <input type="text" name="nome" data-required="1"
                                                placeholder="Insira o nome do sobre" class="form-control input-height "
                                                value="{{ $sobre->titulo }}" />
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-5">
                                            <textarea name="descricao" placeholder="Descrição" class="form-control-textarea " rows="5"> {{ $sobre->descricao }}  </textarea>
