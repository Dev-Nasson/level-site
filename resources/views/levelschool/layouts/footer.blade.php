        ...
        <div class="row align-items-center">
                ...
                <div class="text-wrapper mb-50 wow fadeInLeft">
                        ...
                        <div class="col-md-6 col-sm-12">
                            <div class="information-style-one mb-40">
                                ...
                                <div class="info">
                                    <h4><a href="mailto:support@gmail.com">suporte@gmail.com</a></h4>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6 col-sm-12">
                            <div class="information-style-one mb-40">
                                <div class="icon">
                                    <span><i class="far fa-phone"></i>Ligue</span>
                                </div>
                                <div class="info">
                                    <h4><a href="tel:+0123456789">+244 912 345 678 </a></h4>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="contact-form">
                        <form>
                            <div class="row">
                                ...
                                <div class="col-lg-12">
                                    <div class="form_group">
                                        <textarea class="form_control" placeholder="Digite a Menssagem" name="message"></textarea>
                                    </div>
                                </div>
                                <div class="col-lg-12">
                                    <div class="form_group">
            ...
            <div class="col-lg-4">
                <div class="img-holder mb-50 wow fadeInRight">
                    ...
                    <img src="assets/images/contact/sobre.jpg" alt="Contact Image">
                </div>
            </div>
        </div>
    </div>
...
<footer class="footer-area">
    ...
    <div class="container">
        ...
        <div class="footer-top pt-15 pb-40">
            <div class="row align-items-center">
                <div class="col-md-6">
                ...
                <div class="col-md-6">
                    <div class="text-wrapper mb-40 wow fadeInRight">
                        <h3>
                            <span class="blue-dark">Level Soft </span>
                        </h3>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="copyright-text">
                        <p>&copy; 2023. Todos os direitos reservados Levelsoft</p>
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="footer-nav float-lg-right">
                        <ul>
                            <li><a href="service-details.html">Definições e Privacidade  </a></li>
                            {{-- <li><a href="service-details.html">Faqs</a></li> --}}
                            <li><a href="service-details.html">Projectos</a></li>
                        </ul>
                    </div>
                </div>
            </div>
