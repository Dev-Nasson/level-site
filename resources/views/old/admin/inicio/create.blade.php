            ...
            <div id="app">
                ...
                <div class="container-fluid" id="container-wrapper">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800"> Formulario Início </h1>
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="./">Home</a></li>
                            <li class="breadcrumb-item active" aria-current="page"> Formulario Início </li>
                        </ol>
                            ...
                            <div class="card mb-4">
                                ...
                                <div class="card-body">
                                    ...
                                    <form action="{{ route('inicio.store') }}" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">Selecione o ícone</label>
                                            <input type="text" name="icone" placeholder="Insira o ícone"
                                                class="form-control ">
                                        </div>
                                    ...
                                    --}}
                                        ...
                                        <div class="form-group mt-4 ">
                                            ...
                                            <select name="seccao" id=""
                                                class="custom-select @error('seccao') is-invalid @enderror">
