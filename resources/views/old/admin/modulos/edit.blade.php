        ...
        <div id="content">
            ...
            <div class="container-fluid" id="container-wrapper">
                ...
                <div class="d-sm-flex align-items-center justify-content-between mb-4">
                    <h1 class="h3 mb-0 text-gray-800"> Editar conteudo da pagina de projectos </h1>
                    <ol class="breadcrumb">
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                ...
                                <form action="{{ route('projecto.update', $projecto->id) }}" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="titulo" value="{{$projecto->titulo}}" placeholder="Insira o titulo" class="form-control">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea name="descricao" id=""  rows="3" class="form-control">{{$projecto->descricao }}</textarea>
