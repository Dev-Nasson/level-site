        ...
        <div id="content">
            ...
            <div class="container-fluid" id="container-wrapper">
                ...
                <div class="d-sm-flex align-items-center justify-content-between mb-4">
                    <h1 class="h3 mb-0 text-gray-800"> Projectos </h1>
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="./">Home</a></li>
                        <li class="breadcrumb-item active" aria-current="page"> Projectos </li>
                    </ol>
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                ...
                                <form action="{{ route('projecto.store') }}" method="post" enctype="multipart/form-data">
